...
export default function SupermarketCheckoutPage() {
  ...
  const items = getItemsByType('product');
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Supermarket Checkout</h1>
      <p className="text-gray-500 mb-8">Complete your order for supermarket items.</p>
      <CheckoutForm
        items={items}
